...
import { loadAsyncParsed, loadAsyncString, saveAsyncStringify, saveAsyncString, clearAsyncStorage, removeAsyncItem } from "./storage"
...
test("clearAsyncStorage", async () => {
  ...
  expect(AsyncStorage.clearAsyncStorage).toHaveBeenCalledWith()
})
